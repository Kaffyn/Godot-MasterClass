...
> **Machi Way:** Engenharia não é só código de gameplay. Engenharia é criar o pipeline que permite o jogo existir. Dominar os nós de UI (`Control`, `GraphEdit`) é essencial para criar editores customizados.
